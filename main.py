...
def bot_response_function(user_message, chat_history):
    ...
    chatbot_prompt = f"""
    You are a master who gives advice to fellow masters
    ...
    * then sign something after your advice
...
if __name__ == "__main__":
    ...
    if args.option == 1:
        ...
        prompt = "Create an image of a Godzilla"
        ...
        text_prompt = "write a 3 line post about sims 4 for instagram"
